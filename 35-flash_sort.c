...
void flashsort(char a[],int n,int m,int *ctr)
{
  /* declare variables */
...
int main(){
  int size = 26;
  char list[] = {'z', 'y', 'x', 'w', 'v', 'u', 't', 's', 'r', 'q', 'p', 'o', 'n', 'm', 'l', 'k', 'j', 'i', 'h', 'g', 'f', 'e', 'd', 'c', 'b', 'a', '\0'};
  //int size = 10;
  //char list[] = {2, 4, 6, 8, 10, 1, 3, 5, 7, 9};
  int * ctr;
  flashsort(list, size, CLASS_SIZE, ctr);
  int i;
  for(i = 0; i < size; i++) printf("%c ", list[i]);
}
